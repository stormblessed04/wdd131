...
// Add search event listeners - one for button click and one for enter keypress
...
function search() {
    // Get input value and filter recipes by it
    ...
    return `
        <div class="recipe-card">
            ...
            <div class="recipe-info">
                ...
                <p class="recipe-description mobile-hide">${recipe.description}</p>
            </div>
        </div>
    `
}
...
// Initializer function for inital page render
function init() {
    // Random number for starting recipe
